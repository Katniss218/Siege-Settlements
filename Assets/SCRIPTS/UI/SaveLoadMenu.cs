...
namespace SS.UI
{
	public class SaveLoadMenu : MonoBehaviour
	{
		...
		private GameObject SpawnSaveElement( SaveElementData data )
		{
			...
			if( data.isSaveState )
			{
				obj = Object.Instantiate( AssetManager.GetPrefab( AssetManager.BUILTIN_ASSET_IDENTIFIER + "Prefabs/UI/Level Save State (UI)" ), this.listContentContainer );
			}
			else
			{
				obj = Object.Instantiate( AssetManager.GetPrefab( AssetManager.BUILTIN_ASSET_IDENTIFIER + "Prefabs/UI/Level (UI)" ), this.listContentContainer );
			}
