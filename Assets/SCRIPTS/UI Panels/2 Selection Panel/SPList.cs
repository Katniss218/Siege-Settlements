...
namespace SS.UI
{
	...
	{
		private Dictionary<SSObjectDFS, GameObject> icons = new Dictionary<SSObjectDFS, GameObject>();
		...
		public void AddIcon( SSObjectDFS obj, Sprite icon )
		{
			if( obj == null )
			{
		...
		public void RemoveIcon( SSObjectDFS obj )
		{
			if( obj == null )
			{
