...
#warning depending on the material type, different properties are saved.

			//if( this.materialType == MaterialType.Opaque )
			//{
			...
			//}
			/*else*/ if( this.materialType == MaterialType.PlantOpaque || this.materialType == MaterialType.PlantTransparent )
			{
